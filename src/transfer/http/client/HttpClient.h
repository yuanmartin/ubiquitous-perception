...
namespace http_client
{
	...
	public:
		CHttpClient() = default;
        CHttpClient(const std::string& strAuth,const std::string& strHost,const int& s32Post);
		~CHttpClient() = default;
	...
	private:
        ...
        void BuildHeard(const std::string& strPage,const std::string& strContentType,const std::string& strReqType,std::ostream& ostreamHeard);
